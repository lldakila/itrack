...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="fileDocument" ng-controller="fileDocumentCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile listen-barcode>
  ...
  <div class="app-content content container-fluid">
        ...
        <div class="content-body">
			<div class="row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">File Document</h2>
				</div>
				...
				<div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
					<div class="breadcrumb-wrapper col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">File Document</li>
					  </ol>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<div class="alert alert-info mb-2" role="alert">
						Scan barcode, or press Ctrl+Enter to enter barcode, or filter documents and select from results to <strong>file</strong> document
					</div>
				</div>
			</div>
			<div class="row">
									...
									<table class="table table-bordered ">
										...
										<tbody>
											<tr ng-repeat="d in documents | filter:search">
												...
												<td>
													<button class="btn btn-info" ng-click="app.file(this,d)" data-toggle="tooltip" data-placement="top" title="File"><i class="icon-android-folder-open"></i></button>
												</td>
											</tr>
										</tbody>
										<tfoot>
	...
	<script src="modules/barcode-listener-file.js<?=$ver?>"></script>	
	<script src="common/file.js<?=$ver?>"></script>
	<script src="modules/file.js<?=$ver?>"></script>

	<!-- controller -->
	<script src="controllers/file.js<?=$ver?>"></script>
  </body>
</html>
