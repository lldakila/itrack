...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="groups" ng-controller="groupsCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile>
				...
				<div class="content-header-right breadcrumbs-right breadcrumbs-top col-lg-6">
						<div class="breadcrumb-wrapper col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="groups-list.html" class="info">Groups</a>
							</li>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title" id="basic-layout-form">Goups</h4>
						...
						<div class="card-body collapse in" aria-expanded="true" style="">
							<div class="card-block">
								<form class="form" novalidate autocomplete="off" name="formHolder.group">
									<div class="form-body">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="group_name" ng-class="{'border-danger': formHolder.group.group_name.$touched && formHolder.group.group_name.$invalid}" ng-model="group.group_name" ng-disabled="controls.btns.ok" required>
													<span class="help-block danger" ng-show="formHolder.group.group_name.$touched && formHolder.group.group_name.$invalid">Group Name is required</span>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Group Description</label>
													<input type="text" class="form-control" name="group_description" ng-class="{'border-danger': formHolder.group.group_description.$touched && formHolder.group.group_description.$invalid}" ng-model="group.group_description" ng-disabled="controls.btns.ok" required>
													<span class="help-block danger" ng-show="formHolder.group.group_description.$touched && formHolder.group.group_description.$invalid">Group Description is required</span>
												</div>
											</div>
										</div>
	...
	<script src="modules/groups.js<?=$ver?>"></script>
	
	<!-- controller -->
	<script src="controllers/groups.js<?=$ver?>"></script>
  </body>
</html>
