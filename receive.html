...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="receive" ng-controller="receiveCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile listen-barcode>
  ...
  <div class="app-content content container-fluid">
        ...
        <div class="content-body">
			<div class="row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">Receive Document</h2>
				</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="alert alert-info mb-2" role="alert">
						Scan barcode, or press Ctrl+Enter to enter barcode, or filter documents and select from results to <strong>receive</strong> document
					</div>
				</div>
			</div>
			<div class="row">
									...
									<table class="table table-bordered ">
										...
										<tbody>
											<tr ng-repeat="d in documents | filter:search">
												...
												<td>
													<button class="btn btn-sm btn-info" ng-click="app.receive(this,d)" data-toggle="tooltip" data-placement="top" title="Receive"><i class="icon-download5"></i></button>
													<button class="btn btn-sm btn-danger" ng-click="app.open(this,d)" data-toggle="tooltip" data-placement="top" title="Actions"><i class="icon-list"></i></button>
												</td>
											</tr>
										</tbody>
										<tfoot>
	...
	<script src="modules/barcode-listener-receive.js<?=$ver?>"></script>	
	<script src="common/receive.js<?=$ver?>"></script>
	<script src="modules/receive.js<?=$ver?>"></script>

	<!-- controller -->
	<script src="controllers/receive.js<?=$ver?>"></script>
  </body>
</html>
