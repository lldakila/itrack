angular.module('barcode-listener-document',['bootstrap-modal','form-validator-dialog','bootstrap-growl']).directive('listenBarcode', function($document,$rootScope,$http,$window,bootstrapModal,validateDialog,growl,$q) {
