...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="officesList" ng-controller="officesListCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile>
        ...
        <div class="content-body">
			<div class="row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">Offices</h2>
				</div>
				...
				<div class="breadcrumb-wrapper col-xs-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Offices
					</li>
				  </ol>
				</div>
			  </div>
						...
						<div class="card-body collapse in">
							<div class="table-hover">
								<table class="table table-bordered ">
									...
									<tbody>
										<tr ng-repeat="m in filterData = (offices | filter:search) | pagination: currentPage:pageSize">
											<td>{{m.dept}}</td>
											<td>{{m.office}}</td>
											<td>{{m.shortname}}</td>
											<td>
												<button class="btn btn-info" ng-click="app.add(this,m)"><i class="icon-edit2"></i></button>
												<button class="btn btn-secondary" ng-click="app.delete(this,m)" ng-show="profile.pages_access.maintenance.delete.delete_item"><i class="icon-trash-o"></i></button>
											</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
											<td colspan="4" style="text-align: right;">
												<div class="float-right bg-info.bg-darken-1"><ul uib-pagination direction-links="false" boundary-links="true" total-items="filterData.length" ng-model="currentPage" max-size="maxSize"></ul></div>
											</td>
										</tr>											
									</tfoot>
								</table>
	...
	<script src="modules/offices.js<?=$ver?>"></script>

	<!-- controller -->
	<script src="controllers/offices.js<?=$ver?>"></script>
  </body>
</html>
