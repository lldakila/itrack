...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="options" ng-controller="optionsCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile>
        ...
        <div class="content-body">
			<div class="row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">Options</h2>
				</div>
						...
						<div class="card-body collapse in">
							<div class="table-hover">
								<table class="table table-bordered ">
									...
									<tbody>
										<tr ng-repeat="option in filterData = (options | filter:search) | pagination: currentPage:pageSize">
											<td>{{option.id}}</td>
											<td>{{option.choice}}</td>
											<td>{{option.description}}</td>
											<td>
												<button class="btn btn-info" ng-click="app.add(this,option)"><i class="icon-edit2"></i></button>
												<button class="btn btn-secondary" ng-click="app.delete(this,option)" ng-show="profile.pages_access.maintenance.delete.delete_item"><i class="icon-trash-o"></i></button>
											</td>
										</tr>
									</tbody>
									<tfoot>
	...
	<script src="modules/options.js<?=$ver?>"></script>

	<!-- controller -->
	<script src="controllers/options.js<?=$ver?>"></script>
  </body>
</html>
