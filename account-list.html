...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="accountList" ng-controller="accountListCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile>
						...
						<div class="card-body collapse in">
							<div class="table-hover">
								<table class="table table-bordered ">
									...
									<tbody>
										<tr ng-repeat="u in filterData = (users | filter:search) | pagination: currentPage:pageSize">
											<td>{{u.employee_id}}</td>
											<td>{{u.group_name}}</td>
											<td>{{u.fname}}</td>
											<td>{{u.lname}}</td>
											...
											<td style="width:135px;">
												<button class="btn btn-sm btn-info" ng-click="app.view(this,u)"><i class="icon-search7"></i></button>
												<button class="btn btn-sm btn-secondary" ng-click="app.delete(this,u)" ng-show="profile.pages_access.accounts.delete.delete_account"><i class="icon-trash-o"></i></button>
											</td>
										</tr>
									</tbody>
									<tfoot>
	...
	<!-- controller -->
	<script src="controllers/account-list.js<?=$ver?>"></script>
  </body>
</html>
