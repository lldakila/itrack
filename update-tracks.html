...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="updateTracks" ng-controller="updateTracksCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile listen-barcode>
  ...
  <div class="app-content content container-fluid">
        ...
        <div class="content-body">
			<div class="row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">Update Tracks</h2>
				</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="alert alert-info mb-2" role="alert">
						Scan barcode, or press Ctrl+Enter to enter barcode, or filter documents and select from results to <strong>update</strong> tracks
					</div>
				</div>
			</div>
			<div class="row">
									...
									<table class="table table-bordered ">
										...
										<tbody>
											<tr ng-repeat="d in documents | filter:search">
												...
												<td>
													<button class="btn btn-sm btn-info" ng-click="app.view(this,d)" data-toggle="tooltip" data-placement="top" title="Update Track"><i class="icon-search7"></i></button>
												</td>
											</tr>
										</tbody>
										<tfoot>
	...
	<script src="document/modules/barcode-listener-action.js<?=$ver?>"></script>	
	<script src="modules/update-tracks.js<?=$ver?>"></script>

	<!-- controller -->
	<script src="controllers/update-tracks.js<?=$ver?>"></script>
  </body>
</html>
