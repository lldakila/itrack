...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="documentType" ng-controller="documentTypeCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile>
        ...
        <div class="content-body">
			<div class="row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">Document Types</h2>
				</div>
				...
				<div class="breadcrumb-wrapper col-xs-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item">Maintenance
					</li>
					<li class="breadcrumb-item active">Document Types
					</li>
				  </ol>
				</div>
			  </div>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<button class="btn btn-info float-lg-right" ng-click="app.add(this,null)">Add</button>
				</div>
			</div>
			<br>
			<div class="row">
						...
						<div class="card-body collapse in">
							<div class="table-hover">
								<table class="table table-bordered ">
									...
									<tbody>
										<tr ng-repeat="dt in filterData = (doc_types | filter:search) | pagination: currentPage:pageSize">
											<td>{{dt.document_type}}</td>
											<td>{{dt.transaction_id.transaction}}</td>
											<td>{{dt.shortname}}</td>
											<td>
												<button class="btn btn-info" ng-click="app.add(this,dt)"><i class="icon-search7"></i></button>
												<button class="btn btn-secondary" ng-click="app.delete(this,dt)" ng-show="profile.pages_access.maintenance.delete.delete_item"><i class="icon-trash-o"></i></button>
											</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
											<td colspan="4" style="text-align: right;">
												<div class="float-right"><ul uib-pagination direction-links="false" boundary-links="true" total-items="filterData.length" ng-model="currentPage" max-size="maxSize"></ul></div>
											</td>
										</tr>											
									</tfoot>
								</table>
	...
	<script src="modules/document-types.js<?=$ver?>"></script>

	<!-- controller -->
	<script src="controllers/document-types.js<?=$ver?>"></script>
  </body>
</html>
