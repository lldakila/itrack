...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body ng-app="transactions" ng-controller="transactionsCtrl" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar" account-profile>
						...
						<div class="card-body collapse in">
							<div class="table-hover">
								<table class="table table-bordered ">
									...
									<tbody>
										<tr ng-repeat="tran in filterData = (trans | filter:search) | pagination: currentPage:pageSize">
											<td>{{tran.transaction}}</td>
											<td>{{tran.days}}</td>
											<td>{{tran.shortname}}</td>
											<td>
												<button class="btn btn-info" ng-click="app.add(this,tran)"><i class="icon-edit2"></i></button>
												<button class="btn btn-secondary" ng-click="app.delete(this,tran)" ng-show="profile.pages_access.maintenance.delete.delete_item"><i class="icon-trash-o"></i></button>
											</td>
										</tr>
									</tbody>
									<tfoot>
	...
	<script src="modules/transcations.js<?=$ver?>"></script>

	<!-- controller -->
	<script src="controllers/transcations.js<?=$ver?>"></script>
  </body>
</html>
